...
export const RETURN_CAUSE_HINTS: Record<ReturnCause, string> = {
  ...
  courier:
    "غلطة من المندوب/شركة الشحن — الشحن يتحمّله الشحن نفسه، والعربون يتحجز لحد ما العميلة تقرر، ومش هيتحسب عليها",
  shop: "غلطة من المحل — الشحن علينا، والعربون يتحجز لحد ما العميلة تقرر، ومش هيتحسب عليها",
