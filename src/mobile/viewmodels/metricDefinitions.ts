...
export const MOBILE_METRIC_DEFINITIONS: readonly MetricDefinition[] = [
  ...
  // a zero — see `emptyValueAr` below for what a REAL zero looks like.
  {
    id: "owner_net_profit",
    labelAr: "صافي الربح",
    source: "owner_financial_summary().netProfit over the selected period",
    authority: "revenue − cogs − expense, the same subtraction as pnl().netProfit",
    capability: "owner",
    emptyValueAr: "لا حركة في الفترة",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 6,
  ...
  {
    id: "owner_gross_profit",
    labelAr: "مجمل الربح",
    source: "owner_financial_summary().grossProfit over the selected period",
    authority: "revenue − cogs, the canonical pnl().grossProfit",
    capability: "owner",
    emptyValueAr: "لا حركة في الفترة",
    errorValueAr: "—",
    unitAr: "ج.م.",
  ...
  {
    id: "owner_revenue",
    labelAr: "صافي المبيعات",
    source: "owner_financial_summary().revenue over the selected period",
    authority: "SUM(ledger_lines) WHERE account='revenue' — already net of returns",
    capability: "owner",
    emptyValueAr: "لا مبيعات في الفترة",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 8,
  },
  {
    id: "owner_expenses",
    labelAr: "المصروفات",
    source: "owner_financial_summary().expenses over the selected period",
    authority: "SUM(ledger_lines) WHERE account='expense' — NOT the expenses table",
    capability: "owner",
    emptyValueAr: "لا مصروفات في الفترة",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 9,
  ...
  {
    id: "owner_returns_value",
    labelAr: "قيمة المرتجعات",
    source: "owner_financial_summary().returnsValue over the selected period",
    authority: "revenue lines written by return_confirmed — already deducted, display only",
    capability: "owner",
    emptyValueAr: "لا مرتجعات في الفترة",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 10,
  ...
  {
    id: "owner_stock_value",
    labelAr: "قيمة المخزون",
    source: "owner_financial_summary().stockValue — a POSITION, never windowed",
    authority: "SUM(ledger_lines.amount_delta) WHERE account='stock'",
    capability: "owner",
    emptyValueAr: "لا مخزون",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 11,
  ...
  {
    id: "owner_wallet_balances",
    labelAr: "أرصدة الخزن",
    source: "owner_financial_summary().walletBalances — a POSITION, never windowed",
    authority: "SUM(wallet) per canonical_wallet_subject(), mirroring canonicalWallet()",
    capability: "owner",
    emptyValueAr: "لا حركة على الخزن",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 12,
  ...
  {
    id: "owner_supplier_payable",
    labelAr: "مستحقات الموردين",
    source: "owner_financial_summary().supplierPayable — a POSITION, never windowed",
    authority: "SUM(ledger_lines) WHERE account='payable_supplier', by supplier id",
    capability: "owner",
    emptyValueAr: "لا مستحقات للموردين",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 13,
  ...
  {
    id: "owner_courier_receivable",
    labelAr: "لك عند المندوبين",
    source: "owner_financial_summary().courierReceivable — a POSITION, never windowed",
    authority: "SUM(ledger_lines) WHERE account='receivable_courier', by courier id",
    capability: "owner",
    emptyValueAr: "لا مستحقات لك",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 14,
  ...
  {
    id: "owner_courier_payable",
    labelAr: "عليك للمندوبين",
    source: "owner_financial_summary().courierPayable — a POSITION, never windowed",
    authority: "SUM(ledger_lines) WHERE account='payable_courier', by courier id",
    capability: "owner",
    emptyValueAr: "لا مستحقات عليك",
    errorValueAr: "—",
    unitAr: "ج.م.",
    href: "/owner",
    priority: 15,
